...
class RouteCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusBg = route.isActive
        ? AppColors.success
        : AppColors.backgroundSecondary;
    final statusFg = route.isActive ? Colors.white : AppColors.textSecondary;
    final accent = route.isActive ? AppColors.success : AppColors.textDisabled;
